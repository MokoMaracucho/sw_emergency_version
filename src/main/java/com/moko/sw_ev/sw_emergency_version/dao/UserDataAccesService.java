...
public class UserDataAccesService implements UserDao {
	...
	public List<User> selectAllUsers() {
		final String sql = "SELECT id_user, prenom_user FROM tb_user";
		return jdbcTemplate.query(sql, (resultSet, i) -> {
			...
			return new User(id_user, gender_user, first_name_user, last_name_user, age_user, email_user, occupation_user, privilege_user);
		});
	}
